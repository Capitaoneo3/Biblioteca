...
public class GuardaCodigo {
    ...
    public void checaLivroMaisVendido() {
        ...
        System.out.println("O Livro mais vendido foi: " + retornaLivroPorISBN13(chave) + " com um total de "
                + valorComparavel + " vendas!");
    }
...
// bw.write("Oi, eu sou o "+jp.getNome()+" e eu tenho "+jp.getIdade()+" anos");bw.close()
// ;